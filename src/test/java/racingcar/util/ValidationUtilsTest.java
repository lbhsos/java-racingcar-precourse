...
public class ValidationUtilsTest {
    ...
    @ParameterizedTest
    @ValueSource(strings = {"123456789", "112", "1111"})
    @DisplayName("숫자만 있는 문자열로 숫자만 있는지 검증하면 true 리턴한다.")
    ...
    @DisplayName("숫자가 아닌 문자열로 숫자만 있는지 검증하면 false 리턴한다.")
    ...
    @DisplayName("문자만 있는 문자열로 문자만 있는지 검증하면 true 리턴한다.")
    ...
    @DisplayName("문자가 아닌 문자열로 문자만 있는지 검증하면 false 리턴한다.")
